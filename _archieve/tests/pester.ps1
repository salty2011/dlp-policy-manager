...
Remove-Module dlp-policy-manager -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\dlp-policy-manager\dlp-policy-manager.psd1"
Import-Module "$PSScriptRoot\..\dlp-policy-manager\dlp-policy-manager.psm1" -Force
