...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\dlp-policy-manager\functions", "$global:testroot\..\dlp-policy-manager\internal\functions"),
...
$CommandPath = @(
    "$global:testroot\..\dlp-policy-manager\functions"
    "$global:testroot\..\dlp-policy-manager\internal\functions"
)
